      ...
      <div className="hero  min-h-screen  lg:px-20">
        <div className="hero-content flex-col lg:flex-row w-full gap-10">
          ...
          >
            ...
            <p>
              Ketinggian berada di zona perbukitan sekitar 300 – 500 mdpl (meter
              di atas permukaan laut). Padukuhan Karangsari terletak di dalam
              wilayah Kalurahan Pengkol. Batas wilayah:
            </p>
            <ol>
